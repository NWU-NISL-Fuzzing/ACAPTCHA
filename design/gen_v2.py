...
def main(captcha_text, captcha_save_path):
    ...
    for i, each in enumerate(labels_list):
        ...
        generate_captcha(each, fill_color, background, ttf_list1, captcha_path)
...
if __name__ == '__main__':
    ...
    while i < 60:
        ...
        captcha_save_path_root = '../datasets/version/v8/'
        captcha_save_path_500_root = '../datasets/500/v8/org_imgs/'
        # 空白背景的图像
