...
# 有背景
def generate_captcha(code, font_color, nobg_image, ttf_list, captcha_path1, captcha_path2):
    """
    生成验证码
    :param code: 字符内容
    ...
    # line_num = 3
    image_bg = create_noise_line(image_nobg, width, line_num,font_color)

    image_bg = image_bg.resize((WIDTH, HEIGHT), Image.ANTIALIAS)

    image_nobg.save(captcha_path1)
...
def main(captcha_text, captcha_save_path1, captcha_save_path2):
    ...
    for i, each in enumerate(labels_list):
        ...
        generate_captcha(each, fill_color, background, ttf_list, captcha_path1, captcha_path2)
...
if __name__ == '__main__':
    ...
    while i < 1000:
        ...
        captcha_save_path_500_root = 'F:/bishe/datasets/version/v8/pix2pix/train/bg/org_img'
        # 空白背景的图像
        captcha_save_path_500_root1 = 'F:/bishe/datasets/version/v8/pix2pix/train/no_bg/'
